  ...
  const [popularBookshelves, setPopularBookshelves] = useState([
    {
      ...
      image: 'https://images.unsplash.com/photo-1610398000003-8b2f2e1b2f1c?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80',
      createdBy: {
        _id: '1',
        username: 'user1',
        image: 'https://images.unsplash.com/photo-1610398000003-8b2f2e1b2f1c?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80'
