      ...
      <div className=" flex lg:flex-row flex-col justify-center items-center bg-white dark:bg-black rounded-lg shadow-lg z-20 lg:p-5 p-3 lg:w-4/5  w-full">
              ...
              <label >
                <div className="flex flex-col items-center justify-center h-full">
                  <div className="flex flex-col justify-center items-center">
                    ...
                    <p className="text-lg">The cover image is the bookshelf's first book!</p>
                  </div>
                </div>
                <input
                  type="file"
        ...
        <div className="flex flex-1 flex-col gap-6 dark:bg-black lg:pl-5 mt-5 w-full bg-yellow-300">
          <div className='flex flex-col'>
              <p className="mb-2 font-semibold text:lg sm:text-xl">Bookshelf Title</p>
              <select
                onChange={(e) => {
              ...
              >
                <option value="others" className="sm:text-bg bg-white dark:bg-gray-900">Select bookshelf title</option>
                {bookshelfNames.map((bookshelf) => (
                  <option className="text-base border-0 outline-none capitalize bg-white  dark:bg-gray-900 text-black dark:text-white " value={bookshelf}>
                    {bookshelf}
                  </option>
                ))}
              </select>
